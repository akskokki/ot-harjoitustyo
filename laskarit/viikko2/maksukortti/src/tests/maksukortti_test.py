...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_edullisesti_toimii_minimimaaralla(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
    ...
    def test_syo_maukkaasti_toimii_minimimaaralla(self):
    ...
    def negatiivisen_summan_lataaminene_ei_muuta_saldoa(self):
